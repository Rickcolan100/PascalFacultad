...
begin
 ...
 if(e.codo <> 0)then begin
  ...
  readln(e.asiento);
  writeln('Ingrese valor de la entrada: ');
  readln(e.monto);
 end;
end;
...
begin
 for i:=1 to 7 do begin
  ...
  while(v[i] <> nil) do begin
   ...
   writeln('Valor de la  entrada:',  v[i]^.dato.monto);
...
begin
 if(ln <> nil)then begin
  ...
  writeln('Cantidad de entradas vendidas: ',ln^.dato.asiento);
  writeln('--------------------------------------');
  imprimir(ln^.sig);
 end;
end;
...
begin
 ...
 writeln('-----------------------------------------------------------------------------------------------------------');
 writeln('- LISTADO DE OBRAS EN LA SEMANA -');
 imprimirv(v);
 writeln('-----------------------------------------------------------------------------------------------------------');
